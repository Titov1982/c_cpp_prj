...
struct fiber_context_t
{
  ...
  void (*fiber_func)(void);     // Указатель на рабочую функцию потока
  void* fiber_func_args;        // Указатель на память с аргументами рабочей функции потока
};
...
main(int argc, char *argv[])
{
  ...
  printf("main: switch to %s\n",
    ...
    // Переключаемся с основного контекста на выбранный рабочий для старта работы
